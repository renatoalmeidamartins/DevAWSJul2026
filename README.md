...
- Permissões "finas" no DynamoDB (Fine-grained access control):
  - [Documentação](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/specifying-conditions.html)
  - [Blog post](https://aws.amazon.com/blogs/aws/fine-grained-access-control-for-amazon-dynamodb/)
...
- Contexto em  Lambda expões diversos dados sobre o runtime dele. Estes podem ser obtidos com operações na linguagem em uso, como por exemplo [em Python](https://docs.aws.amazon.com/lambda/latest/dg/python-context.html)
...
## Links do dia 4
- [Referência de como deve ser uma aplicação "moderna", 12 factor app](https://12factor.net/)
...
- Step functions:
  - Quase todos os serviços AWS suportam [integração via SDK](https://docs.aws.amazon.com/step-functions/latest/dg/supported-services-awssdk.html)
